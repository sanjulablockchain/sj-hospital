...
/**
 * `#top`: clinical staff and equipment behind the themed header and the
 * page's only <h1>, closed off by a fact strip and the ticker of bookable
 * specialities.
 *
 ...
 */
export function ChannelingHero() {
  return (
    <section
      id="top"
    ...
    >
      ...
      >
        <Image
          src="/images/echanneling-hero.jpg"
          alt="Clinical staff with medical equipment at St. Joseph Hospital Negombo"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto mt-auto flex w-full max-w-[1440px] gap-5.5 px-5 sm:px-8 lg:px-11">
        ...
        <div className="flex-1 pb-11">
          ...
          <h1 className="font-display animate-sj-up mt-4.5 text-[clamp(38px,6.4vw,100px)] leading-[0.9] font-extrabold tracking-[-0.045em] text-white uppercase">
            Make an <span className="text-[#2CA6F0]">appointment.</span>
          </h1>
          ...
          <div className="animate-sj-up mt-8 flex flex-col items-start gap-5.5">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                Find a consultant <span aria-hidden>&rarr;</span>
              </a>
              <a
                href="#help"
