 ...
 * shared `sj-fill` utility, which carries the `* { color: inherit }` the three
 * differently coloured spans need and sits behind `@media (hover: hover)` so a
 * touch device cannot latch a card into the filled state.
 */
