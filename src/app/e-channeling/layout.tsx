...
// Same arrangement as the /about-us, /contact-us, /accommodation, /network,
// /international-care, /pharmacy and /facilities layouts: the header lives
// inside the hero and scrolls away with it rather than sticking, so
