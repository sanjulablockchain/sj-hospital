...
// /pharmacy and /facilities layouts: the header lives inside the hero and
// scrolls away with it rather than sticking, so flowHeader cancels the
// sticky-header anchor offset for every in-page anchor on this route.
//
